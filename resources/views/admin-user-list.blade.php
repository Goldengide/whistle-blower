      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30">Users</p>
            @if(Session::has('message'))
               <p class="alert-success">{{Session::get('message')}}</p>
               <!-- <p class="alert-success">hvhgvhvh</p> -->
            @endif
            ...
            <table id="myTable" class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($user->role != "admin")
                   <a href="{{url('admin/tip/users/make-admin/'.$user->id)}}"><span class="icon icon-eye-open text-info"> Make Admin</span></a>
                   @else
                   <span class="icon icon-check text-info">Admin</span>
                   @endif

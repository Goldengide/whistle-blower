      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30"><a href="{{url('tip/new')}}" class="btn btn-large btn-primary"><i class="ti-plus"></i>Add Tip</a></p>
            ...
            <table id="myTable" class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                   <a href="{{url('/tip/view/'.$tip->id)}}"><span class="icon icon-eye-open text-info"> Details</span></a>
                   <a href="{{url('/tip/edit/'.$tip->id)}}"><span class="icon icon-eye-open text-info"> Edit</span></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
